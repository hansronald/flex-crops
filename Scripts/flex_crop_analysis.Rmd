...
This plot shows us, in terms om tonnes produced, which countries are producing the greatest share.
...
crop_data_temp = crop_data %>% 
  filter(country == "Ukraine")

crop_proportion_plot_per_country(crop_data_temp, category = "Flex crop", min_land_area = 500000, min_proportion = 0.1, max_proportion = 0.2, stacked = TRUE)
```
...
plot_country_crop_data(crop_data, country_var, measure_var, n_items, year_var, stacked = FALSE)

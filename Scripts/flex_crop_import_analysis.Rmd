...
flex_crop_import_share = data.frame(years = years, n_countries_with_flex_crop_dominating_import = n_countries_with_flex_crop_dominating_import)
```


```{r flex_crop_dominant_imports_plot, echo = FALSE}
flex_crop_import_share %>% 
  ggplot(aes(years, n_countries_with_flex_crop_dominating_import)) +
    geom_line() +
    labs(title = "Number of countries with flex crop as most imported crop", x = "", y = "Number of countries")
```

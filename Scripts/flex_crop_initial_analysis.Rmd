...
Because some smaller countries, especially island nations, are dominated by one particular crop. Because of this they are excluded in the analysis. The limit is set somewhat arbitrarily to 5000 sqm. These are the countries excluded on that list.
...
crop_proportion_plot_per_country(crop_data, category = "Flex crop", min_land_area = 5000, min_proportion = 0.05)
crop_proportion_plot_per_country(crop_data, category = "Emerging flex crop", min_land_area = 5000, min_proportion = 0.05)

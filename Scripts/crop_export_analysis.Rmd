...
write.csv(export_commodity_value, "~/Google Drive/Skola/SRC/Thesis/Code/Output/global_annual_crop_group_export_data.csv")
...
flex_crop_export_share %>% 
  ggplot(aes(year, n_countries_with_flex_crop_dominating_export)) +
    geom_line() +
    labs(title = "Number of countries with flex crop as most exported crop", x = "", y = "Number fo countries")

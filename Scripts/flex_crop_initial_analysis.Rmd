...
Because some smaller countries, especially island nations, are dominated by one particular crop (small island nations for example mainly have coconut crops). Because of this they are excluded in the analysis. The limit is set somewhat arbitrarily to 5000 sqm. These are the countries excluded on that list.

```{r  out.width = "100%", out.height = "100%", fig.height = 6, echo = FALSE}
# Extract countries with land area smaller than 5000, and print them
countries_excluded = crop_data %>% 
...
Large countries will naturally be among the top producers. Here we look what proportion of the total crop production is flex crop production and how has it changed over time. With this information we can see if the flex crop production is actually displacing other production.
```{r  out.width = "100%", out.height = "100%", fig.height = 6, echo = FALSE}
crop_proportion_plot_per_country(crop_data, category = "Flex crop", min_land_area = 5000, min_proportion = 0.25, stacked = FALSE)
```



### Individual emerging flex crop planted proportion of total land area
```{r  out.width = "100%", out.height = "100%", fig.height = 6, echo = FALSE}
crop_proportion_plot_per_country(crop_data, category = "Emerging flex crop", min_land_area = 5000, min_proportion = 0.15, stacked = TRUE)
...
## largest producers and area harvested of flex crops in 2016
...
### Production per country in in 2016.
...
## Area harvested per country in 2016
...
### Production per country in 2016
...
### Yield harvested per country in 2016
...
## Flex crops.
Absolute and proportional (1961 - 2016)
...
```{r out.width = "100%", out.height = "100%", fig.height = 6, echo = FALSE}
get_break_points_per_country(crop_data, crop = "Oil palm fruit", measure = "Production")
```
...
```{r out.width = "100%", out.height = "100%", fig.height = 6, echo = FALSE}
get_break_points_per_country(crop_data, crop = "Soybeans", measure = "Production")
```
...
```{r out.width = "100%", out.height = "100%", fig.height = 6, echo = FALSE}
get_break_points_per_country(crop_data, crop = "Sugar cane", measure = "Production")
```
...
```{r out.width = "100%", out.height = "100%", fig.height = 6, echo = FALSE}
get_break_points_per_country(crop_data, crop = "Maize", measure = "Production")
```
...
#theme_set(theme_light(base_size = 12))
#production_year = c(1975, 1990, 2000, 2016)
...
```{r eval=FALSE, include=FALSE}
#production_year = c(2002, 2007, 2012, 2016)
